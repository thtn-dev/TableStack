...
export type { Profile as StoreProfile } from "@bindings/internal/store/models";
export type {
...
} from "@bindings/internal/db/models";

// ---------------------------------------------------------------------------
// Convenience plain-object aliases (avoids `new store.Profile()` noise)
// ---------------------------------------------------------------------------

import type { Profile as StoreProfile } from "@bindings/internal/store/models";
import type {
  ConnectResult as DBConnectResult,
  DatabaseInfo as DBDatabaseInfo,
  TableInfo as DBTableInfo,
